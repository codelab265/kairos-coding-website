                    ...
                    <div class="col-xl-6 col-lg-5">
                        <div class="section-title is-sticky">
                            <span class="sub-title"><img class="img-fluid" src="images/subtitle-icon.png"
                                    alt=""> Our Direction</span>
                            <h2 class="title">
                                Ready to take your business to the next level with cutting-edge software solutions?
                            </h2>
                            <p>
                                Get
                                in touch with us
                            ...
                            <div class="location-wrapper location-style-1 bg-black">
                                <div class="location-inner">
                                    <div class="location-info">
                                        ...
                                        <div class="city-info">
                                            <h5 class="city-name"><a href="#">UK</a></h5>
                                            <div class="city-location">
                                                <div class="location-item">
                                                    <i class="icon"><img class="img-fluid"
                                                            src="images/icon-location.png" alt=""></i>
                                                    <div class="list-label">
                                                        19 Horseshoe Close, Hemel Hempstead, UK
                                                    </div>
                                                </div>
                                                <div class="location-item">
                                                    <i class="icon"><img class="img-fluid"
                                                            src="images/icon-phone-call.png" alt=""></i>
                                                    <div class="list-label">
                                                        (+44) 7519 331 999
                                                    </div>
                                                </div>
                                                <div class="location-item">
                                                    <i class="icon"><img class="img-fluid" src="images/icon-email.png"
                                                            alt=""></i>
                                                    <div class="list-label">
                        ...
                        <div class="col-md-10">
                            <div class="section-title text-center">
                                <span class="sub-title d-flex justify-content-center"><img class="img-fluid"
                                        src="images/subtitle-icon.png" alt=""> contact us</span>
