                 ...
                 <div class="sticky-top" style="top: 80px;">
                     <div class="section-title mb-0">
                         <span class="sub-title">
                             <img class="img-fluid" src="{{ asset('images/subtitle-icon.png') }}" alt="" />
                             Service Details
                         </span>
                         <h2 class="title">
                     ...
                     <div class="ps-xxl-5 ms-0 ms-md-5 pb-5 pb-lg-0">
                         <p class="mb-5">
                             Our custom software development services are designed to bring your unique ideas to life.
                             From initial
                             concept through to deployment, we work closely with you to develop software solutions that
                             align
                 ...
                 <div class="steps-wrapper">
                     <div class="steps-item">
                         ...
                         <div class="step-info">
                             ...
                             <h3 class="step-title">End-to-End Development</h3>
                             <p>From planning and design to implementation and maintenance.</p>
                             <div class="step-image"><img class="img-fluid" src="images/steps/01.png" alt="">
                             </div>
                         </div>
                     </div>
                     <div class="steps-item">
                         ...
                         <div class="step-info">
                             ...
                             <h3 class="step-title">Tailored Solutions</h3>
                             <p>
                                 Custom-built to meet your specific business needs.
                             </p>
